...
if [[ ":$FPATH:" != *":/home/togalle/.zsh/completions:"* ]]; then export FPATH="/home/togalle/.zsh/completions:$FPATH"; fi
...
# zmodload zsh/zrof # This is for auditing to see which processes take up most time on startup
...
chpwd() ls -a --group-directories-first

# Use "nv" instead of "nvim"
alias nv="nvim '.'"
...
alias dotfiles='/usr/bin/git --git-dir=$HOME/dotfiles/ --work-tree=$HOME' # Save dotfiles to github

# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# fnm
FNM_PATH="/home/togalle/.local/share/fnm"
if [ -d "$FNM_PATH" ]; then
  export PATH="/home/togalle/.local/share/fnm:$PATH"
  eval "`fnm env`"
fi
...
. "/home/togalle/.deno/env"
# Initialize zsh completions (added by deno install script)
autoload -Uz compinit
compinit
# bun completions
[ -s "/home/togalle/.bun/_bun" ] && source "/home/togalle/.bun/_bun"
